    ...
    var body: some View {
      ZStack {
        ...
        Rectangle()
          ...
          .frame(width: uLineWidth, height: lineHeight, alignment: .center)
          .offset(x: 0, y: -22)
